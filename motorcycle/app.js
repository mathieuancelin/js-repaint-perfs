...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function dbMap(e){return(0,_dom.h)("td",{className:e.elapsedClassName},[(0,_dom.h)("span.foo",[e.formatElapsed]),(0,_dom.h)("div.popover.left",[(0,_dom.h)("div.popover-content",[e.query]),(0,_dom.h)("div.arrow")])])}function databasesMap(e){return(0,_dom.h)("tr",[(0,_dom.h)("td.dbname",[e.dbname]),(0,_dom.h)("td.query-count",[(0,_dom.h)("span",{className:e.lastSample.countClassName},[e.lastSample.nbQueries])])].concat(e.lastSample.topFiveQueries.map(dbMap)))}function main(e){return{DOM:e.databases.map(function(e){return(0,_dom.h)("div",{"static":!0},[(0,_dom.h)("table.table.table-striped.latest-data",{},[(0,_dom.h)("tbody",e.map(databasesMap))])])})}}function DBMONDriver(){return _most2["default"].create(function(e){function t(){e(ENV.generateData().toArray()),Monitoring.renderRate.ping(),setTimeout(t,ENV.timeout)}t()})}var _most=require("most"),_most2=_interopRequireDefault(_most),_core=require("@motorcycle/core"),_dom=require("@motorcycle/dom");(0,_core.run)(main,{DOM:(0,_dom.makeDOMDriver)("#app-container"),databases:DBMONDriver});

},{"@motorcycle/core":2,"@motorcycle/dom":5,"most":98}]},{},[111]);
