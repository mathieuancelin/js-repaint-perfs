...
var _virtualDomVtreeDiff = require('virtual-dom/vtree/diff');

var _virtualDomVtreeDiff2 = _interopRequireDefault(_virtualDomVtreeDiff);

var _virtualDomVdomPatch = require('virtual-dom/vdom/patch');

var _virtualDomVdomPatch2 = _interopRequireDefault(_virtualDomVdomPatch);

var _virtualDomVdomCreateElement = require('virtual-dom/vdom/create-element');
...
var Application = (function () {
  ...
  _createClass(Application, [{
    ...
    value: function start(rootComponent) {
      ...
      var initialState = _defineProperty({}, rootComponentName, rootComponent);

      this.cursor = new _freezerJs2['default'](initialState);
      this.rootComponent = this.cursor.get()[rootComponentName];

      this.render = function (currentState) {
        return _this.rootComponent.render();
      };
      this.updater = function (currentState) {
        _this.loop.update(currentState);
      };

      this.loop = (0, _mainLoop2['default'])(this.cursor.get(), this.render, { diff: _virtualDomVtreeDiff2['default'], create: _virtualDomVdomCreateElement2['default'], patch: _virtualDomVdomPatch2['default'] });
    ...
    key: 'stateUpdatedHandler',
    value: function stateUpdatedHandler(currentState) {
...
},{"freezer-js":7,"main-loop":13,"virtual-dom/vdom/create-element":25,"virtual-dom/vdom/patch":28,"virtual-dom/vtree/diff":40}],2:[function(require,module,exports){
'use strict';
...
var Component = (function (_Freezer) {
  _inherits(Component, _Freezer);
  ...
  function Component(application, parent, name) {
    ...
    _get(Object.getPrototypeOf(Component.prototype), 'constructor', this).call(this, initialState);

    this.on('update', function (currentState) {
      _this.application.stateUpdatedHandler(currentState);
    });
  }
...
;
module.exports = exports['default'];
},{"freezer-js":7}],3:[function(require,module,exports){
'use strict';
...
},{"./application":1,"./component":2,"./routerComponent":4}],4:[function(require,module,exports){
'use strict';
...
var RouterComponent = (function (_Component) {
  ...
  function RouterComponent(application) {
    var parent = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
    var name = arguments.length <= 2 || arguments[2] === undefined ? 'router' : arguments[2];
    var routes = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];

    _classCallCheck(this, RouterComponent);

    var trie = new _routeTrie2['default']();
    var compiledRoutes = {};
    ...
    _get(Object.getPrototypeOf(RouterComponent.prototype), 'constructor', this).call(this, application, parent, name, initialState);
  }

  _createClass(RouterComponent, [{
    key: 'activate',
    value: function activate() {
      _get(Object.getPrototypeOf(RouterComponent.prototype), 'activate', this).call(this);
    ...
    value: function deactivate() {
      ...
      _get(Object.getPrototypeOf(RouterComponent.prototype), 'deactivate', this).call(this);
    }
  }, {
    key: '_getCurrentMatch',
    value: function _getCurrentMatch() {
      var hash = this.application.ownerDocument.location.hash;
      var currentPattern = null;
      var currentMatch = this.state.trie.match(hash.slice(1));

      if (currentMatch !== null) {
        for (var pattern in this.state.compiledRoutes) {
    ...
    key: 'onPopStateHandler',
    value: function onPopStateHandler() {
      ...
      if (currentMatch !== null) {
        var currentPattern = currentMatch.node._nodeState.pattern;
        var currentRoute = this.state.compiledRoutes[currentPattern];
        var currentComponent = currentRoute.initializer(currentMatch, this);
        var currentComponentName = currentComponent.name;

        this.state.set(_defineProperty({
    ...
    value: function render() {
      ...
      if (this.currentComponent === undefined || this.currentComponent === null) {
        return new _virtualDomVnodeVtext2['default']('Invalid route!');
      }

      return (_currentComponent = this.currentComponent).render.apply(_currentComponent, arguments);
    }
  }, {
    ...
    get: function get() {
      var currentComponentName = this.state.currentComponentName;
      return this.currentComponentName !== undefined && this.currentComponentName !== null ? this.state[this.currentComponentName] : null;
    }
  }]);
...
module.exports = exports['default'];
},{"./component":2,"route-trie":20,"virtual-dom/vnode/vtext":38}],5:[function(require,module,exports){
...
},{"./src/freezer":9}],8:[function(require,module,exports){
'use strict';
...
},{"./emitter":8,"./frozen":10,"./mixins":11,"./utils.js":12}],10:[function(require,module,exports){
'use strict';
...
},{"./emitter":8,"./mixins":11,"./utils":12}],11:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":32,"is-object":22}],40:[function(require,module,exports){
var isArray = require("x-is-array")
...
},{"../vnode/handle-thunk":30,"../vnode/is-thunk":31,"../vnode/is-vnode":33,"../vnode/is-vtext":34,"../vnode/is-widget":35,"../vnode/vpatch":37,"./diff-props":39,"x-is-array":23}]},{},[3])(3)
});