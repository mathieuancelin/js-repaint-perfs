...
Elm.Opt = Elm.Opt || {};
Elm.Opt.make = function (_elm) {
   "use strict";
   _elm.Opt = _elm.Opt || {};
   if (_elm.Opt.values) return _elm.Opt.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "dbname" in v && "lastSample" in v ? {_: {}
                                                                              ,dbname: typeof v.dbname === "string" || typeof v.dbname === "object" && v.dbname instanceof String ? v.dbname : _U.badPort("a string",
                                                                              v.dbname)
                                                                              ,lastSample: typeof v.lastSample === "object" && "countClassName" in v.lastSample && "nbQueries" in v.lastSample && "topFiveQueries" in v.lastSample ? {_: {}
                                                                                                                                                                                                                                     ,countClassName: typeof v.lastSample.countClassName === "string" || typeof v.lastSample.countClassName === "object" && v.lastSample.countClassName instanceof String ? v.lastSample.countClassName : _U.badPort("a string",
                                                                                                                                                                                                                                     v.lastSample.countClassName)
                                                                                                                                                                                                                                     ,nbQueries: typeof v.lastSample.nbQueries === "number" && isFinite(v.lastSample.nbQueries) && Math.floor(v.lastSample.nbQueries) === v.lastSample.nbQueries ? v.lastSample.nbQueries : _U.badPort("an integer",
                                                                                                                                                                                                                                     v.lastSample.nbQueries)
                                                                                                                                                                                                                                     ,topFiveQueries: typeof v.lastSample.topFiveQueries === "object" && v.lastSample.topFiveQueries instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.lastSample.topFiveQueries.map(function (v) {
                                                                                                                                                                                                                                        return typeof v === "object" && "elapsedClassName" in v && "formatElapsed" in v && "query" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                          ,elapsedClassName: typeof v.elapsedClassName === "string" || typeof v.elapsedClassName === "object" && v.elapsedClassName instanceof String ? v.elapsedClassName : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                          v.elapsedClassName)
                                                                                                                                                                                                                                                                                                                                          ,formatElapsed: typeof v.formatElapsed === "string" || typeof v.formatElapsed === "object" && v.formatElapsed instanceof String ? v.formatElapsed : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                          v.formatElapsed)
                                                                                                                                                                                                                                                                                                                                          ,query: typeof v.query === "string" || typeof v.query === "object" && v.query instanceof String ? v.query : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                          v.query)} : _U.badPort("an object with fields `elapsedClassName`, `formatElapsed`, `query`",
                                                                                                                                                                                                                                        v);
                                                                                                                                                                                                                                     })) : _U.badPort("an array",
                                                                                                                                                                                                                                     v.lastSample.topFiveQueries)} : _U.badPort("an object with fields `countClassName`, `nbQueries`, `topFiveQueries`",
                                                                              v.lastSample)} : _U.badPort("an object with fields `dbname`, `lastSample`",
         v);
      })) : _U.badPort("an array",v);
   });
   var viewTopFiveQueries = function (query) {
      return A2($Html.td,
      _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
      "Query ",
      query.elapsedClassName))]),
      _U.list([$Html.text(query.formatElapsed)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("popover left")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("popover-content")]),
                      _U.list([$Html.text(query.query)]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("arrow")]),
                      _U.list([]))]))]));
   };
   var viewDatabase = function (database) {
      return A2($Html.tr,
      _U.list([]),
      A2($Basics._op["++"],
      _U.list([A2($Html.td,
              _U.list([$Html$Attributes.$class("dbname")]),
              _U.list([$Html.text(database.dbname)]))
              ,A2($Html.td,
              _U.list([$Html$Attributes.$class("query-count")]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class(database.lastSample.countClassName)]),
              _U.list([$Html.text($Basics.toString(database.lastSample.nbQueries))]))]))]),
      A2($List.map,
      $Html$Lazy.lazy(viewTopFiveQueries),
      database.lastSample.topFiveQueries)));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.table,
      _U.list([$Html$Attributes.$class("table table-striped latest-data")]),
      _U.list([A2($Html.tbody,
      _U.list([]),
      A2($List.map,$Html$Lazy.lazy(viewDatabase),model))]))]));
   });
   ...
   var actions = _U.list([A2($Signal.map,
   LoadData,
   ...
   app.tasks);
   var Database = F2(function (a,b) {
      return {dbname: a,lastSample: b};
   });
   var LastSample = F3(function (a,b,c) {
      return {countClassName: a,nbQueries: b,topFiveQueries: c};
   });
   var Query = F3(function (a,b,c) {
      return {elapsedClassName: a,formatElapsed: b,query: c};
   });
   return _elm.Opt.values = {_op: _op
                            ,Query: Query
