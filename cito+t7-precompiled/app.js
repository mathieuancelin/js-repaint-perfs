...
function database(db) {
  return {tag:"tr",key: db.name,children:[{tag:"td",attrs:{"class":"dbname"},children:db.name},{tag:"td",attrs:{"class":"query-count"},children:{tag:"span",attrs:{"class":db.lastSample.countClassName},children:db.lastSample.queries.length+""}},].concat(db.lastSample.topFiveQueries.map(queries))};
};
